                ...
                Expanded(
                  child: StreamBuilder(
                    ...
                    builder: (context, event) {
                      ...
                      // If the selected segment has no completed orders, show context-specific message
                      if (today && todayOrderDataList.isEmpty) {
                        return Center(
                          child: Text(
                            'No complete orders today',
                            style: AppTextStyles.body16,
                          ),
                        );
                      }
                      if (month && monthOrderDataList.isEmpty) {
                        return Center(
                          child: Text(
                            'No complete orders this month',
                            style: AppTextStyles.body16,
                          ),
                        );
                      }
                      if (year && yearOrderDataList.isEmpty) {
                        return Center(
                          child: Text(
                            'No complete orders this year',
                            style: AppTextStyles.body16,
                          ),
                        );
                      }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        'الخدمات: ${currentServiceData.servicesOrPrimary.length}',
